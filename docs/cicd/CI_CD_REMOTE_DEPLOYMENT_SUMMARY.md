...
ssh -p 22 subbu@dlt.aurigraph.io "docker logs traefik"

# System logs
ssh -p 22 subbu@dlt.aurigraph.io "journalctl -xe"

# Docker container status
ssh -p 22 subbu@dlt.aurigraph.io "docker ps -a"
```
...
# Test connection
ssh -p 22 -vvv subbu@dlt.aurigraph.io
