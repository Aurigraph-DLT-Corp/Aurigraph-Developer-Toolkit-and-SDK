...
class ConfigManager {
    ...
    loadNodeConfig() {
        const nodeType = process.env.NODE_TYPE || types_1.NodeType.BASIC;
        const baseConfig = {
    ...
    validateConfiguration() {
        ...
        if (this.config.node.nodeType === types_1.NodeType.VALIDATOR && this.config.consensus.validators.length === 0) {
