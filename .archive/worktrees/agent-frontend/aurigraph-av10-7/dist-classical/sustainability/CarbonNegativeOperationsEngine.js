...
(function (SequestrationMethod) {
    ...
    SequestrationMethod["GEOLOGICAL_STORAGE"] = "GEOLOGICAL_STORAGE";
...
class CarbonNegativeOperationsEngine extends events_1.EventEmitter {
    ...
    carbonBudgets = new Map();
    carbonOperations = new Map();
    carbonCredits = new Map();
    renewableEnergy = new Map();
    carbonSinks = new Map();
    netZeroStrategies = new Map();
...
//# sourceMappingURL=CarbonNegativeOperationsEngine.js.map