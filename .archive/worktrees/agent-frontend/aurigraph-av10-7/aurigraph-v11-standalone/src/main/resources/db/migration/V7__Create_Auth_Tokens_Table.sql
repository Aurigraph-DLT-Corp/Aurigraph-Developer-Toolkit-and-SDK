...
CREATE INDEX idx_is_revoked ON auth_tokens(is_revoked);
CREATE INDEX idx_created_at ON auth_tokens(created_at);
CREATE INDEX idx_status ON auth_tokens(status);
CREATE INDEX idx_user_id_status ON auth_tokens(user_id, status);
CREATE INDEX idx_user_id_token_type ON auth_tokens(user_id, token_type);
CREATE INDEX idx_client_ip ON auth_tokens(client_ip);
CREATE INDEX idx_parent_token_id ON auth_tokens(parent_token_id);
...
CREATE INDEX idx_audit_user_id ON auth_token_audit(user_id);
CREATE INDEX idx_audit_timestamp ON auth_token_audit(timestamp);
CREATE INDEX idx_audit_action ON auth_token_audit(action);
