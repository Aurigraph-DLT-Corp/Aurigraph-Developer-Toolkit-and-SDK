...
exports.VizorRealtimeDashboard = void 0;
const Logger_1 = require("../core/Logger");
const express_1 = __importDefault(require("express"));
const ws_1 = require("ws");
class VizorRealtimeDashboard {
    logger;
    app;
    server = null;
    wss = null;
    ...
    blockchainData = [];
    constructor() {
        this.logger = new Logger_1.Logger('VizorDashboard');
...
<body>
    ...
    generateTransaction() {
        const types = ['standard', 'smart-contract', 'rwa', 'bridge', 'governance'];
        const statuses = ['pending', 'processing', 'validated', 'completed'];
        return {
...
exports.VizorRealtimeDashboard = VizorRealtimeDashboard;
//# sourceMappingURL=VizorRealtimeDashboard.js.map