...
let FeatureStore = class FeatureStore extends events_1.EventEmitter {
    logger;
    isInitialized = false;
    ...
    featureLineage = new Map();
    // Data storage and caching
    featureCache = new Map();
    dataCache = new Map();
    computedFeatures = new Map();
    // Real-time processing
    streamProcessors = new Map();
    realTimeFeatures = new Map();
    eventQueue = [];
...
exports.FeatureStore = FeatureStore = __decorate([
