...
public class RegistryManagementService {
    ...
    /**
     * Broadcast registry update via WebSocket
     */
    public void broadcastRegistryUpdate(String registryType, String entryId, String name,
                                       RegistryUpdateMessage.Action action, String status) {
        RegistryUpdateMessage message = new RegistryUpdateMessage(registryType, entryId, action);
        message.setName(name);
        message.setStatus(status);
        message.setVerificationStatus(status);
        webSocketMessageService.broadcastRegistryUpdate(registryType, message);
        Log.debugf("Broadcast registry update: type=%s, entry=%s, action=%s", registryType, entryId, action);
    }
}
