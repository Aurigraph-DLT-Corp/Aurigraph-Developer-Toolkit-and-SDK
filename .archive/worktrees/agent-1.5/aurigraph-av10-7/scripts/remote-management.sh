...
# Aurigraph AV11-7 Remote Management and Maintenance System
...
<html>
<head>
    <title>Aurigraph AV11-7 Maintenance Report</title>
    <style>
...
<body>
    <div class="header">
        <h1>🚀 Aurigraph AV11-7 Maintenance Report</h1>
...
HTML
    ...
    <footer style="text-align: center; margin-top: 30px; color: #666;">
        <p>Generated by Aurigraph AV11-7 Remote Management System</p>
    </footer>
</body>
</html>
HTML
...
show_help() {
    cat << 'EOF'
🤖 Aurigraph AV11-7 Remote Management System
