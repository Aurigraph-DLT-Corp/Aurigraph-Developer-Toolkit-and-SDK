# GitHub Issue for Manual Creation

## Instructions
1. Go to: https://github.com/Aurigraph-DLT-Corp/Aurigraph-DLT/issues/new
2. Copy and paste the content below
3. Add labels: jira-sync, deployment, success, av10-7, unified-dashboard, performance, quantum, milestone
4. Assign to: SUBBUAURIGRAPH
