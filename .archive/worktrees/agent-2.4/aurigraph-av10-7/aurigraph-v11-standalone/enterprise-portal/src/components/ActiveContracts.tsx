...
import {
  ...
  DialogActions, Alert, Stepper, Step, StepLabel, TextareaAutosize
} from '@mui/material';
import { Add, Code, Description, AccountBalance, Check, Close } from '@mui/icons-material';
...
export const ActiveContracts: React.FC = () => {
  ...
  const [entries, setEntries] = useState<TripleEntry[]>([
    {
      id: 'te1',
      debit: 'Account A',
      credit: 'Account B',
        ...
        <DialogContent>
          ...
          {activeStep === 0 && (
            <Box>
              ...
              <TextField
                ...
                type="number"
                value={contractForm.value}
                onChange={(e) => setContractForm({...contractForm, value: parseInt(e.target.value)})}
                margin="normal"
              />
            </Box>
          )}
          ...
          {activeStep === 1 && (
            <TextField
              ...
              onChange={(e) => setContractForm({...contractForm, legalText: e.target.value})}
              margin="normal"
            />
          )}
