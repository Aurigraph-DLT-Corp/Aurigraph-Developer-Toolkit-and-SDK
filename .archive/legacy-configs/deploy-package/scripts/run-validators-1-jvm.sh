#!/bin/sh
# Aurigraph V12 - Validator Cluster 1 Runner (JVM Mode)
...
echo "=== Aurigraph V12 Validator Cluster 1 (JVM Mode) ==="
...
start_validator 1
echo "Waiting 30s for validator-1 to complete migrations..."
sleep 30
...
while true; do
    ...
    # Only exit if no nodes are responding after 3 consecutive failures
