...
exit
ssh subbu@dlt.aurigraph.io "echo SSH key works"
```
...
ssh subbu@dlt.aurigraph.io "netstat -tlnp | grep -E '9003|9004|3000|80|443'"

# Kill conflicting process if needed
ssh subbu@dlt.aurigraph.io "lsof -i :9003 && kill -9 <PID>"
```
...
ssh subbu@dlt.aurigraph.io "docker pull ghcr.io/aurigraph-dlt-corp/aurigraph-dlt/aurigraph-v11:latest"
```
...
2. Check remote server: `ssh subbu@dlt.aurigraph.io`
