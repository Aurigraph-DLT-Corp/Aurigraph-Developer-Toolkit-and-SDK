...
class SecondaryTokenVersioningServiceTest {
    ...
    class VersionCreation {
        ...
        void testCreateVersion_NewVersion_Initialized() {
            // Act
            SecondaryTokenVersion created = versioningService.createVersion(tokenId, "1.1.0")
                .await().indefinitely();
        ...
        void testCreateVersion_DefaultState_SetToPendingVVB() {
            ...
            // Assert
            assertEquals(TokenStatus.PENDING_VVB, created.getStatus());
        }
    ...
    class VersionActivation {
        ...
        void testActivateVersion_StateChange_ToPendingExecute() {
            // Arrange
            SecondaryTokenVersion version = versioningService.createVersion(tokenId, "1.1.0")
                .await().indefinitely();
            ...
            // Assert
            assertTrue(activated.getStatus() == TokenStatus.PENDING_EXECUTE ||
                      activated.getStatus() == TokenStatus.ACTIVE);
        }
    ...
    class VVBSubmissionWorkflow {
        ...
        void testSubmitToVVB_RequiresVVBApproval_Mandatory() {
            ...
            // Act
            var result = versioningService.submitToVVB(version.getId())
                .await().indefinitely();
        ...
        void testSubmitToVVB_SubmitsPendingVersion_ForApproval() {
            ...
            // Act
            boolean submitted = versioningService.submitToVVB(version.getId())
                .await().indefinitely();
        ...
        void testSubmitToVVB_StatusMarked_AsInVVB() {
            ...
            // Act
            versioningService.submitToVVB(version.getId())
                .await().indefinitely();
            ...
            // Assert
            assertTrue(updated.getStatus() == TokenStatus.PENDING_VVB ||
                      updated.getStatus() == TokenStatus.IN_VVB);
        }
    ...
    class ApprovalRejectionHandling {
        ...
        void testApprovalOutcome_Approved_ActivatesVersion() {
            ...
            // Act
            versioningService.markApproved(version.getId())
                .await().indefinitely();
            ...
            // Assert
            assertTrue(updated.getStatus() == TokenStatus.ACTIVE ||
                      updated.getStatus() == TokenStatus.PENDING_EXECUTE);
        }
        ...
        void testApprovalOutcome_Rejected_MarksAsRejected() {
            ...
            // Act
            versioningService.markRejected(version.getId(), "Compliance issue")
                .await().indefinitely();
            ...
            // Assert
            assertEquals(TokenStatus.REJECTED, updated.getStatus());
        }
    ...
    class MerkleHashGeneration {
        ...
        void testMerkleHash_GeneratedFromUpdates_Deterministic() {
            // Arrange
            SecondaryTokenVersion version1 = versioningService.createVersion(tokenId, "1.1.0")
                .await().indefinitely();
            SecondaryTokenVersion version2 = versioningService.createVersion(tokenId, "1.1.0")
                .await().indefinitely();
        ...
        void testMerkleHash_DifferentUpdates_DifferentHash() {
            ...
            SecondaryTokenVersion version1 = versioningService.createVersion(tokenId, "1.1.0")
                .await().indefinitely();
            SecondaryTokenVersion version2 = versioningService.createVersion(tokenId, "1.2.0")
                .await().indefinitely();
...
class SecondaryTokenVersion {
    ...
    private TokenStatus status = TokenStatus.PENDING_VVB;
