...
CREATE INDEX idx_audit_entity_id ON audit_records(entity_id);
CREATE INDEX idx_audit_actor ON audit_records(actor);
CREATE INDEX idx_audit_timestamp ON audit_records(timestamp);
CREATE INDEX idx_audit_merkle_hash ON audit_records(merkle_hash);
CREATE INDEX idx_audit_archived ON audit_records(archived);
CREATE INDEX idx_audit_operation ON audit_records(operation);

-- Performance monitoring
CREATE INDEX idx_audit_details_key ON audit_record_details(detail_key);
CREATE INDEX idx_audit_chain_timestamp ON audit_chain(chain_timestamp);
...
CREATE INDEX idx_compliance_entity ON compliance_certifications(entity_id);
CREATE INDEX idx_compliance_type ON compliance_certifications(certification_type);
CREATE INDEX idx_compliance_expires ON compliance_certifications(expires_date);
