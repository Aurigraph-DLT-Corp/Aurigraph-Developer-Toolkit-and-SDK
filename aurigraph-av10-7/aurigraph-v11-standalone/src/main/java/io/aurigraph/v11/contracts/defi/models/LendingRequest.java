...
public class LendingRequest {
    ...
    public LendingRequest(String userAddress, LendingOperationType operationType, String asset, BigDecimal amount) {
        this.requestId = java.util.UUID.randomUUID().toString();
        this.requestedAt = Instant.now();
        this.deadline = Instant.now().plusSeconds(600); // 10 minutes default deadline
        this.interestRateMode = InterestRateMode.VARIABLE;
        this.riskTolerance = RiskTolerance.MODERATE;
        this.flashLoanEnabled = false;
        this.autoCompound = false;
        this.autoRebalance = false;
        this.maxSlippage = BigDecimal.valueOf(1.0); // 1% default slippage
