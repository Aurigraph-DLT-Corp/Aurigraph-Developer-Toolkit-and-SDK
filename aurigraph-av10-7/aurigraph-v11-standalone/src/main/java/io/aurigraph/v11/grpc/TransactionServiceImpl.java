...
public class TransactionServiceImpl implements io.aurigraph.v11.proto.TransactionService {
    ...
    @Override
    public Uni<io.aurigraph.v11.proto.TransactionSubmissionResponse> submitTransaction(
            io.aurigraph.v11.proto.SubmitTransactionRequest request) {
    ...
    @Override
    public Uni<io.aurigraph.v11.proto.BatchTransactionSubmissionResponse> batchSubmitTransactions(
            io.aurigraph.v11.proto.BatchTransactionSubmissionRequest request) {
        return Uni.createFrom().item(() -> {
    ...
    @Override
    public Uni<io.aurigraph.v11.proto.TransactionStatusResponse> getTransactionStatus(
            io.aurigraph.v11.proto.GetTransactionStatusRequest request) {
        return Uni.createFrom().item(() -> {
            ...
            io.aurigraph.v11.proto.TransactionStatusResponse.Builder response = io.aurigraph.v11.proto.TransactionStatusResponse
                    .newBuilder()
    ...
    @Override
    public Uni<io.aurigraph.v11.proto.TransactionReceipt> getTransactionReceipt(
            io.aurigraph.v11.proto.GetTransactionStatusRequest request) {
        return Uni.createFrom().item(() -> {
            String txHash = request.getTransactionHash();
            io.aurigraph.v11.proto.TransactionReceipt receipt = receiptCache.get(txHash);
    ...
    @Override
    public Uni<io.aurigraph.v11.proto.CancelTransactionResponse> cancelTransaction(
            io.aurigraph.v11.proto.CancelTransactionRequest request) {
        return Uni.createFrom().item(() -> {
            String txHash = request.getTransactionHash();
            io.aurigraph.v11.proto.Transaction tx = transactionCache.get(txHash);
    ...
    @Override
    public Uni<io.aurigraph.v11.proto.ResendTransactionResponse> resendTransaction(
            io.aurigraph.v11.proto.ResendTransactionRequest request) {
        return Uni.createFrom().item(() -> {
    ...
    @Override
    public Uni<io.aurigraph.v11.proto.GasEstimate> estimateGasCost(
            io.aurigraph.v11.proto.EstimateGasCostRequest request) {
        return Uni.createFrom().item(() -> {
    ...
    public Uni<io.aurigraph.v11.proto.TransactionSignatureValidationResult> validateTransactionSignature(
        ...
        return Uni.createFrom().item(() -> {
            ...
            io.aurigraph.v11.proto.TransactionSignatureValidationResult.Builder result = io.aurigraph.v11.proto.TransactionSignatureValidationResult
                    .newBuilder()
    ...
    @Override
    public Uni<io.aurigraph.v11.proto.PendingTransactionsResponse> getPendingTransactions(
            io.aurigraph.v11.proto.GetPendingTransactionsRequest request) {
        return Uni.createFrom().item(() -> {
    ...
    @Override
    public Uni<io.aurigraph.v11.proto.TransactionHistoryResponse> getTransactionHistory(
            io.aurigraph.v11.proto.GetTransactionHistoryRequest request) {
        return Uni.createFrom().item(() -> {
    ...
    @Override
    public Uni<io.aurigraph.v11.proto.TxPoolStatistics> getTxPoolSize(
            io.aurigraph.v11.proto.GetTxPoolSizeRequest request) {
        return Uni.createFrom().item(() -> {
    ...
    @Override
    public Multi<io.aurigraph.v11.proto.TransactionEvent> streamTransactionEvents(
            io.aurigraph.v11.proto.StreamTransactionEventsRequest request) {
    ...
    private String generateTxHash(io.aurigraph.v11.proto.Transaction tx) {
        return "0x" + Integer.toHexString(Objects.hash(
                tx.getFromAddress(), tx.getToAddress(), tx.getAmount(), System.nanoTime())).substring(0, 8);
    }
