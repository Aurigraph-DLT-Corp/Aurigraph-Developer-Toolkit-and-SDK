...
/**
 * Represents yield farming rewards and staking benefits
 * Tracks multiple reward tokens, boosting mechanisms, and vesting schedules
 */
...
public class YieldFarmRewards {
    ...
    public BigDecimal calculatePendingRewards() {
        ...
        BigDecimal baseRewards = stakedAmount
            ...
            .divide(annualSeconds, 8, BigDecimal.ROUND_HALF_UP);
