 ...
 *
 * Handles token operations including mint, burn, transfer, and RWA
 * tokenization.
 * Supports ERC20-like fungible tokens, ERC721-like NFTs, and real-world asset
 * tokens.
 *
                ...
                return tokenRepository.findByTokenId(request.tokenId())
                                .flatMap(optToken -> {
                                        ...
                                        return tokenRepository.persist(token)
                                                        .flatMap(savedToken -> balanceRepository
                                                                        .findByTokenAndAddress(request.tokenId(),
                                                                                        request.toAddress())
                                                                        .flatMap(optBalance -> {
                                                                                TokenBalance balance = optBalance
                                                                                                .orElse(
                                                                                                                new TokenBalance(
                                                                                                                                request.tokenId(),
                                                                                                                                request.toAddress(),
                                        ...
                                        return balanceRepository
                                                        ...
                                                        .flatMap(optBalance -> {
                                                                ...
                                                                return balanceRepository.persist(balance)
                                                                                .flatMap(savedBalance -> tokenRepository
                                                                                                .persist(token)
                                                                                                .flatMap(savedToken ->
                                                                // Update holder count reactively
                                                                balanceRepository.countHolders(request.tokenId())
                                                                                .flatMap(holderCount -> {
                                                                                        savedToken.updateHolderCount(
                                                                                                        holderCount);
                                                                                        return tokenRepository.persist(
                                                                                                        savedToken)
                                                                                                        .map(finalToken -> {
                                ...
                                .flatMap(optToken -> {
                                        ...
                                        return balanceRepository
                                                        ...
                                                        .flatMap(optFromBalance -> {
                                                                ...
                                                                return balanceRepository.findByTokenAndAddress(
                                                                                request.tokenId(), request.toAddress())
                                                                                .flatMap(optToBalance -> {
                                                                                        TokenBalance toBalance = optToBalance
                                                                                                        .orElse(
                                                                                                                        new TokenBalance(
                                                                                                                                        request.tokenId(),
                                                                                                                                        request.toAddress(),
                                                                                        ...
                                                                                        return balanceRepository
                                                                                                        .persist(fromBalance)
                                                                                                        .flatMap(savedFromBalance -> balanceRepository
                                                                                                                        .persist(toBalance)
                                                                ...
                                                                .flatMap(savedBalance -> {
                                                                        ...
                                                                        return tokenRepository.persist(savedToken)
                                                                                        .map(finalToken -> {
                                                                                                ...
                                                                                                LOG.infof("RWA token created: %s",
                                                                                                                finalToken.getTokenId());
                                                                                                return finalToken;
                                                                                        });
                                                                });
                                        } else {
