package io.aurigraph.v11.pending.defi.models;
 ...
 * Tracks collateral, debt, health factor, liquidation risk
 */
...
public class LoanPosition {
    ...
    public void calculateHealthFactor() {
        ...
        this.healthFactor = adjustedCollateral.divide(totalBorrowedValue, 4, BigDecimal.ROUND_HALF_UP);
    ...
    public void calculateLtv() {
        ...
        this.ltv = totalBorrowedValue.divide(totalCollateralValue, 4, BigDecimal.ROUND_HALF_UP);
    }
