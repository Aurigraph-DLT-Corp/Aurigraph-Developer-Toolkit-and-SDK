    ...
    const sampleContracts: SmartContract[] = [
      {
        ...
        auditReports: [{
          ...
          issues: 2,
          status: 'passed',
          report: 'Contract passed security audit with minor recommendations'
        }],
        gasUsed: 1523456,
      ...
      },
      {
        ...
        version: '2.1.0',
        channelId: 'main',
        address: '0x8f3Cf7ad124309F4e9B8d12D8B5C70E7Cf58fC14',
        deployedBy: '0xDev456...',
      ...
      },
      {
        ...
        verified: false,
        audited: false,
        tags: ['supply-chain', 'tracking', 'iot'],
        methods: [],
        events: [],
        usage: {
          totalCalls: 0,
          ...
          <TableBody>
            {filteredContracts.map((contract) => (
              <TableRow key={contract.id}>
                ...
                <TableCell>
                  <Chip label={channels.find(c => c.id === contract.channelId)?.name || contract.channelId} size="small" />
                </TableCell>
                <TableCell>
                  <Chip
            ...
            <Box>
              ...
              <FormControl fullWidth margin="normal">
                ...
                <Select
                  ...
                  onChange={(e) => setDeploymentForm({ ...deploymentForm, channelId: e.target.value })}
                >
                  {channels.map(ch => (
                    <MenuItem key={ch.id} value={ch.id}>{ch.name}</MenuItem>
                  ))}
              ...
              <FormControl fullWidth margin="normal">
                ...
                <Select
                  ...
                  onChange={(e) => setDeploymentForm({ ...deploymentForm, language: e.target.value as any })}
                >
              ...
              <TextField
                ...
                onChange={(e) => setDeploymentForm({ ...deploymentForm, sourceCode: e.target.value })}
                margin="normal"
              />
              <Box sx={{ mt: 2 }}>
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      onChange={(e) => setDeploymentForm({ ...deploymentForm, compile: e.target.checked })}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      onChange={(e) => setDeploymentForm({ ...deploymentForm, verify: e.target.checked })}
                    />
                  }
