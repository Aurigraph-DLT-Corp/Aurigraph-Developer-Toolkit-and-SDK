...
// Get Started button component removed
      ...
      <section id="platform" className="py-20 px-4 bg-gradient-to-br from-gray-700 to-slate-700">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Aurex Launchpad™ */}
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200 hover:shadow-xl hover:shadow-green-500/20 transition-all duration-300 flex flex-col h-full">
              <div className="text-center mb-4">
                <div className="w-16 h-16 mx-auto mb-3">
                  <img src="/images/launchpad-icon.svg" alt="Aurex Launchpad Dashboard" className="w-full h-full object-contain" />
                </div>
            ...
            {/* Aurex HydroPulse™ */}
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-6 border border-blue-200 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300 flex flex-col h-full">
              <div className="text-center mb-4">
                <div className="w-16 h-16 mx-auto mb-3">
                  <img src="/images/hydropulse-icon.svg" alt="Aurex HydroPulse Water Management" className="w-full h-full object-contain" />
                </div>
            ...
            {/* Aurex SylvaGraph™ */}
            <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-2xl p-6 border border-purple-200 hover:shadow-xl hover:shadow-purple-500/20 transition-all duration-300 flex flex-col h-full">
              <div className="text-center mb-4">
                <div className="w-16 h-16 mx-auto mb-3">
                  <img src="/images/sylvagraph-icon.svg" alt="Aurex SylvaGraph Forest Monitoring" className="w-full h-full object-contain" />
                </div>
            ...
            {/* Aurex CarbonTrace™ */}
            <div className="bg-gradient-to-br from-emerald-50 to-green-50 rounded-2xl p-6 border border-emerald-200 hover:shadow-xl hover:shadow-emerald-500/20 transition-all duration-300 flex flex-col h-full">
              <div className="text-center mb-4">
                <div className="w-16 h-16 mx-auto mb-3">
                  <img src="/images/carbontrace-icon.svg" alt="Aurex CarbonTrace Blockchain Trading" className="w-full h-full object-contain" />
                </div>
