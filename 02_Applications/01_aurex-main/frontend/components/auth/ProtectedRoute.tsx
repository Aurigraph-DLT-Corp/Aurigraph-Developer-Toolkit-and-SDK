/**
 * Protected Route Component for Aurex Platform
 *
 * Provides route protection with Keycloak authentication
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">
              Please sign in to access this content and explore our sustainability solutions.
            </p>
          </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                <div className="flex flex-wrap gap-2 justify-center">
                  {user.roles.map((role) => (
                    <span
                      key={role}
                      className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs bg-green-100 text-green-800"
                    >
                      <Shield className="h-3 w-3" />
                      {role}
                    </span>
