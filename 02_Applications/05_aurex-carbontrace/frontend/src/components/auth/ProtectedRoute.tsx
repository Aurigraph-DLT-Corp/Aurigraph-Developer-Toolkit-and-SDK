/**
 * Protected Route Component for Aurex CarbonTrace
 *
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8">
          <div className="text-center mb-6">
            <div className="text-6xl text-gray-800 mb-4">🌍</div>
            <h2 className="text-2xl font-bold text-gray-900 mb-2">
              Welcome to CarbonTrace
            </h2>
            <p className="text-gray-600">
              Please sign in to access your carbon footprint tracking platform and explore our supply chain monitoring solutions.
            </p>
          </div>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-gray-800 hover:bg-gray-900 text-white py-2 px-4 rounded-md transition-colors"
            >
              Sign In
            </button>
          </div>
